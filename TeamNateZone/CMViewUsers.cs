...
{
    public partial class CMViewUsers : Form
    {
        public CMViewUsers()
        {
            InitializeComponent();
        ...
        private void CMViewUsers_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT Email, fName FirstName, lName LastName, street AS Street, city AS City, state AS State, zip AS ZipCode FROM SignInInfo WHERE clearance = 0", cn);
