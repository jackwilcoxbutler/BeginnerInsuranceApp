...
namespace TeamNateZone
{
    public partial class AdminViewUsers : Form
    {
        ...
        private void ViewUsers_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT Username,fName,lName,Email,street,city,state,zip,clearance,UserID FROM SignInInfo where clearance = 0 or clearance = 1 or clearance = 2 order by UserId Asc, DateRegistered desc", cn);
